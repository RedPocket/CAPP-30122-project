...
CREATE TABLE program_elective
   ...
   course_unit integer,
   equivalent_courses varchar(10),
   instructors varchar(10),
   notes varchar(50));

.separator ","
.import program_elective.csv program_elective
...
CREATE TABLE user_inputs
   (major_pre_courses varchar(100),
   major_elec_courses varchar(100),
   minor_pre_courses varchar(100),
   minor_elec_courses varchar(100),
   courses_taken varchar(100),
   courses_to_take varchar(100),
   start_quarter varchar(100));
